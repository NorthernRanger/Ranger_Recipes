...
3. Download [Ranger_Recipes.modcomponent](https://github.com/NorthernRanger/Ranger_Recipes/releases) and [Ranger_Recipes.dll](https://github.com/NorthernRanger/Ranger_Recipes/releases).
4. Move all the files to your Mods folder.
